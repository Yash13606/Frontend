...
const DeploymentJourney = () => {
  ...
  return (
    <section 
      ref={containerRef}
      className="py-32 md:py-48 bg-[#000000] relative overflow-hidden"
    >
      ...
      <div className="mx-auto max-w-[1400px] px-4 md:px-8 relative z-10">
        <div className="flex flex-col items-center text-center mb-32">
          ...
          <h2 className="mt-8 text-5xl md:text-7xl lg:text-8xl font-black text-white uppercase tracking-tighter leading-[0.85]" style={{ fontFamily: "'Chakra Petch', sans-serif" }}>
            Live in 48 Hours. <br />
            <span className="text-gray-500">Zero Red Tape.</span>
          </h2>
          <div className="mt-10 h-px w-24 bg-white/20" />
          <p className="mt-10 text-lg md:text-xl text-gray-400 font-medium max-w-2xl leading-relaxed uppercase tracking-wide">
        ...
        <motion.div 
          ...
          viewport={{ once: true }}
          className="mt-24 max-w-xl mx-auto border border-white/20 bg-white/5 p-8 relative text-center backdrop-blur-md"
        >
          ...
          <h4 className="text-xl font-bold text-white uppercase tracking-[0.3em] font-[Chakra Petch] mb-6">
            SLA RECONNAISSANCE PROTOCOL
          </h4>
          <p className="text-sm font-mono text-gray-400 leading-relaxed uppercase tracking-widest max-w-xl mx-auto">
          ...
          <div className="mt-10 flex flex-wrap justify-center gap-8 border-t border-white/10 pt-10">
            {[
